...
enum DemoStrings {
    ...
    static let simpleExample = "화해에 BonMot을 적용해보자"
        .styled(
            with:
            .tracking(.point(1)),
    ...
    static let xmlExample: NSAttributedString = {
        ...
        let localizedString = """
            I want to be different. If everyone is wearing <hwahae><BON:noBreakSpace/>black,<BON:noBreakSpace/></hwahae> I want to be wearing <red><BON:noBreakSpace/>red.<BON:noBreakSpace/></red>
        ...
        let accessibleRacketImage = UIImage(named: "")
        ...
        let racket = accessibleRacketImage?.styled(with:
            .color(.red), .baselineOffset(-4.0))

        // Define styles
        let accent = StringStyle(.font(BONFont(name: "SuperClarendon-Black", size: 18)!))
        let hwahae = accent.byAdding(.color(.white), .backgroundColor(BONColor(named: "primary1")!))
        let red = accent.byAdding(.color(.white), .backgroundColor(.red))
        let signed = accent.byAdding(.color(.red))
        ...
        let baseStyle = StringStyle(
            ...
            .xmlRules([
                ...
                .style("red", red),
                .style("signed", signed),
                //.enter(element: "racket", insert: racket as! Composable),
                ]
            )
        )
    ...
    static let xmlWithEmphasis: NSAttributedString = {
        ...
        let emphasis = StringStyle(.emphasis(.italic), .color(.red))
        let strong = StringStyle(.emphasis(.bold), .color(.red))
...
//            knot,
    ...
    static let figureStylesExample: NSAttributedString = {
        ...
        return NSAttributedString.composed(of: [
            "Number Styles".styled(with: garamondStyle, .smallCaps(.fromLowercase), .color(.red)),
    ...
    static let ordinalsExample: NSAttributedString = {
        ...
        return string.styled(with: garamondStyle.byAdding(
            .xmlRules([
                .style("number", garamondStyle.byAdding(.color(.red), .numberCase(.upper))),
    ...
    static let fractionsExample: NSAttributedString = {
        ...
        return string.styled(with: garamondStyle.byAdding(
            .xmlRules([
                .style("fraction", garamondStyle.byAdding(.fractions(.diagonal), .color(.red), .numberCase(.lower))),
                ])
            )
        )
    }()
    ...
    static let scientificInferiorsExample: NSAttributedString = {
        ...
        return string.styled(with: garamondStyle.byAdding(
            .xmlRules([
                ...
                .style("chemical", garamondStyle.byAdding(.color(.red))),
    ...
    static let stylisticAlternatesExample: NSAttributedString = {
        ...
        let callout = StringStyle(.color(.red))
    ...
    static let accessibilitySpeechExamples: [NSAttributedString] = {
        ...
        let style = StringStyle(
            ...
            .adapt(.body),
            .xmlRules([
                .style("punctuation", StringStyle(.color(.red))),
                ...
                .style("low-pitch", StringStyle(.speakingPitch(0.0), .color(.red))),
